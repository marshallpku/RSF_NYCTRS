...
liab_active %<>%
  ...
  mutate(
    ...
    EEC = case_when(
    	...
    	tier_select_ == "t6" & sx >  45000 & sx <=  75000 ~ 45000 * 0.03 + 0.035 * (sx - 45000),
    	tier_select_ == "t6" & sx >  75000 & sx <= 100000 ~ 45000 * 0.03 + 30000 * 0.035 +  0.045 * (sx - 75000), 
...
#*************************************************************************************************************
#                        2.2  ALs and NCs of life annuity and contingent annuity for actives             #####                  
#*************************************************************************************************************
