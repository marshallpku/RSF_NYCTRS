...
#***********************************************************************
## calibration: Initial vested and inactives who are not in pay status  
#***********************************************************************

# For initial PVB of terminated vested and inactive members 
  #  - no corresponding demographic data 
  #  - PVB = AL


# Assume the PVFB for initial vestees and inactives are paid up through out the next 50 years. 
# ALs and Bs of initial terminated vested and inactive members are included in ALx.v and B.v. 
